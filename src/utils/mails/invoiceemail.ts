...
export const sendInvoiceEmail = async (data: InvoiceEmailData) => {
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <p style="color: #555; font-size: 15px;">
            Thank you for choosing Magalela. Please find the details of your invoice below.
          </p>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr class="total-row">
                ...
                <td style="text-align: right; font-size: 15px;">R ${taxAmount.toFixed(2)}</td>
              </tr>
              <tr class="total-row" style="border-top: 2px solid #0F2D63;">
                <td colspan="3" style="text-align: right; font-size: 18px; color: #0F2D63;">Total Due:</td>
                <td style="text-align: right; font-size: 20px; color: #C85A32;">R ${totalAmount.toFixed(2)}</td>
              </tr>
            </tbody>
          </table>
          ...
          <div style="margin: 20px 0 10px; padding: 12px 16px; background: #f9f9f9; border-radius: 6px; border-left: 4px solid #C85A32;">
            ...
            <span class="due-date">${new Date(dueDate).toLocaleDateString('en-ZA', { day: '2-digit', month: 'long', year: 'numeric' })}</span>
          </div>
          ...
          <div class="footer-text">
            <p style="margin: 0;">
              ...
              <a href="mailto:finance@magalela.com" style="color: #C85A32; text-decoration: none; font-weight: 500;">finance@magalela.com</a>
            </p>
          </div>
        </div>
  ...
  await transporter.sendMail({
    ...
    to,
    subject: `Invoice ${invoiceNumber} from Magalela`,
    html,
  });
};
